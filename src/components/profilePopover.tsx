  ...
  return (
    <Popover className="group">
      ...
      <PopoverPanel
        transition
        anchor="bottom end"
        className="border-border/40 bg-blur flex w-96 flex-col gap-2 rounded-lg border p-4 transition duration-200 ease-out [--anchor-gap:32px] data-closed:scale-95 data-closed:opacity-0"
      >
